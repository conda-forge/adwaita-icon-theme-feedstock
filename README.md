...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/adwaita-icon-theme-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/adwaita-icon-theme-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add adwaita-icon-theme
# for installing globally
pixi global install adwaita-icon-theme
```
...
It is possible to list all of the versions of `adwaita-icon-theme` available on your platform:
...
```
pixi search adwaita-icon-theme --channel conda-forge
```
